...
export const mockForms = [
  {
    ...
    description: 'Standard property valuation form for residential properties',
    fields: [
      {
        id: 'field-1',
      ...
      },
      {
        ...
        requiredFor: 'all',
        options: [
          { id: 'opt-1', option: 'Residential', value: 'residential' },
          { id: 'opt-2', option: 'Commercial', value: 'commercial' },
          { id: 'opt-3', option: 'Industrial', value: 'industrial' }
        ]
      },
      {
        id: 'field-3',
